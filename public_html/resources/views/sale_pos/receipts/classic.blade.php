...
<div class="row">
	...
	@if(!empty($receipt_details->logo))
		<img style="max-height: 120px; width: auto;" src="{{$receipt_details->logo}}" class="img img-responsive left">
	@endif
	...
	<!-- business information here -->
	<div class="col-xs-12 text-center" style="margin-top: -110px;">
		<h2  class="text-left" style="margin-left: 95px;" >
			<!-- Shop & Location Name  -->
		...
		@if(!empty($receipt_details->address))
				<small class="text-left" style="margin-left: -305px;" >
				{!! $receipt_details->address !!}
				</small>
		@endif
		@if(!empty($receipt_details->contact))
			<br/>
			<small class="text-left" style="margin-left: -198px;" >
			    {!! $receipt_details->contact !!} </small>
		@endif	
		...
		@if(!empty($receipt_details->invoice_heading))
			<h3 class="text-right" style="margin-top: -75px;">
			...
			<h4 class="text-right" >
				...
				@if(!empty($receipt_details->sales_person_label))
						...
						<small  class="text-left" style="margin-left: -390px;" >
		...
		<p style="width: 100% !important" class="word-wrap">
			...
			<span class="pull-right text-left" style="margin-top: -20px;">
